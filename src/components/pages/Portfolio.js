      ...
      <main className="container d-flex flex-wrap flex-column flex-md-row justify-content-center justify-content-sm-around align-items-center">
        ...
        <div className="card col-10 col-md-5 mt-4 mx-1" >
          ...
          <div className="card-body">
            ...
            <div className="container d-flex flex-column flex-sm-row align-items-center justify-content-around">
              <a href="https://movie-mate-2.herokuapp.com/" className="btn btn-primary col-10 col-sm-5 mb-2">Live Site</a>
              <a href="https://github.com/stevengoldbergm/movie-mate-2.0" className="btn btn-secondary col-10 col-sm-5 mb-2">Github</a>
            </div>
          </div>
        </div>
        ...
        <div className="card col-10 col-md-5 mt-4 mx-1" >
          ...
          <div className="card-body">
            ...
            <div className="container d-flex flex-column flex-sm-row align-items-center justify-content-around">
              <a href="https://text-editor-stevengoldbergm.herokuapp.com/" className="btn btn-primary col-10 col-sm-5 mb-2">Live Site</a>
              <a href="https://github.com/stevengoldbergm/text-editor" className="btn btn-secondary col-10 col-sm-5 mb-2">Github</a>
            </div>
          </div>
        </div>
        ...
        <div className="card col-10 col-md-5 mt-4 mx-1" >
          ...
          <div className="card-body">
            ...
            <p className="card-text small text-muted text-center">Bootstrap | ???</p>
            <div className="container d-flex flex-column flex-sm-row align-items-center justify-content-around">
              <a href="https://tech-blog-stevengoldbergm.herokuapp.com/" className="btn btn-primary col-10 col-sm-5 mb-2">Live Site</a>
              <a href="https://github.com/stevengoldbergm/tech-blog" className="btn btn-secondary col-10 col-sm-5 mb-2">Github</a>
            </div>
          </div>
        </div>
        ...
        <div className="card col-10 col-md-5 mt-4 mx-1" >
          ...
          <div className="card-body">
            ...
            <p className="card-text small text-muted text-center">??? | ??? </p>
            <div className="container d-flex flex-column flex-sm-row align-items-center justify-content-around">
              <a href="https://note-taker-sgm86.herokuapp.com/notes" className="btn btn-primary col-10 col-sm-5 mb-2">Live Site</a>
              <a href="https://github.com/stevengoldbergm/Note-Taker" className="btn btn-secondary col-10 col-sm-5 mb-2">Github</a>
            </div>
          </div>
        </div>
        ...
        <div className="card col-10 col-md-5 mt-4 mx-1" >
          ...
          <div className="card-body">
            ...
            <div className="container d-flex flex-column flex-sm-row align-items-center justify-content-around">
              <a href="https://stevengoldbergm.github.io/weather-dashboard/" className="btn btn-primary col-10 col-sm-5 mb-2">Live Site</a>
              <a href="https://github.com/stevengoldbergm/weather-dashboard" className="btn btn-secondary col-10 col-sm-5 mb-2">Github</a>
            </div>
          </div>
        </div>
        ...
        <div className="card col-10 col-md-5 mt-4 mx-1" >
          ...
          <div className="card-body">
            ...
            <p className="card-text">Make your schedule. Stay on track!<br></br><br></br>The Workday Scheduler utilizes local storage to handle saving tasks, and the JavaScript setInterval() method to dynamically color-code page elements. The current, upcoming, and past time blocks are easily identified at a glance!</p>
            <p className="card-text small text-muted text-center"> Local Storage | JS setInterval </p>
            <div className="container d-flex flex-column flex-sm-row align-items-center justify-content-around">
              <a href="https://stevengoldbergm.github.io/daily-planner/" className="btn btn-primary col-10 col-sm-5 mb-2">Live Site</a>
              <a href="https://github.com/stevengoldbergm/daily-planner" className="btn btn-secondary col-10 col-sm-5 mb-2">Github</a>
            </div>
